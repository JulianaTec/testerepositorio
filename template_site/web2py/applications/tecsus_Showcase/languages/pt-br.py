...
'Database lists (grid)': 'Database lists (grid)',
'Database lists (smartgrid)': 'Database lists (smartgrid)',
'Date': 'Date',
'db': 'bd',
'DB Model': 'Modelo BD',
'Delete:': 'Apagar:',
...
'Sale (SQLFORM.factory)': 'Sale (SQLFORM.factory)',
'Sale Car': 'Sale Car',
